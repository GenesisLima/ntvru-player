...
package br.ufpe.ntvru.player.view;
...
public class TestPlayer extends VlcjTest {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        //NativeLibrary.addSearchPath(RuntimeUtil.getLibVlcCoreName(), "c:\\Program Files\\VideoLAN\\VLC\\libvlccore.dll");
    	NativeLibrary.addSearchPath(
                RuntimeUtil.getLibVlcLibraryName(), "c:/Program Files/VideoLAN/VLC/");
    	NativeLibrary.addSearchPath(
                RuntimeUtil.getLibVlcCoreName(), "c:/Program Files/VideoLAN/VLC/");
    	NativeLibrary.addSearchPath(
                RuntimeUtil.getPluginsDirectoryName(), "c:/Program Files/VideoLAN/VLC/plugins/");
    ...
    public TestPlayer(String[] args) {
        ...
        vlcArgs.add("dummy");
          ...
          vlcArgs.add("--input-slave");
          vlcArgs.add("timecode://");
          vlcArgs.add("--timecode-fps");
          vlcArgs.add("30000/1001");
    ...
    private void showTimecode() {
        ...
        for (TrackInfo trackInfo : mediaPlayer.getTrackInfo()) {
            System.out.println("trackInfo: " + mediaPlayer.getTrackInfo(TrackType.values()));
    ...
    private final class TestPlayerMediaPlayerEventListener extends MediaPlayerEventAdapter {
        ...
        public void playing(MediaPlayer mediaPlayer) {
        	...
        	System.out.println("TRACK INFO "+mediaPlayer.getTrackInfo());
        }
...
//            }
            ...
            // Demo the marquee
            mediaPlayer.setMarqueeText("NTVRU");
